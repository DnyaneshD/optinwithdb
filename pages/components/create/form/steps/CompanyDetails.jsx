...
const CompanyDetails = (props) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="highlighted-box">
        ...
        <p><b>This step you do only once.</b> If you have posted previously, please just enter your business email and the data will be populated automatically.</p>
        ...
        <div className="row full company-details">
            ...
            <div className="half">
                ...
                type="text" placeholder="Enter your business email" id="email"/>
            </div>
        </div>
        ...
        <div className="row full company-details">
            <div className="half">
                ...
                id="location" type="text" placeholder="Company Headquarters" />
            </div>
            <div className="half">
                <p className="mandatory">Company website</p>
                <input
                {...register("website", {required:true})} 
                id="website" type="text" placeholder="https://companywebsite.com" />
            </div>
        </div>
        <div className="row full company-description job-description">
            ...
            <Controller
                render={({
                    ...
                    <RichEditor
                    data={valuesDerivedFromState && valuesDerivedFromState.description}
                    onChange={onChange}
                    />)}
                    name="description"
                    control={control}
        ...
        <div className="full cta-holder">
            <input id="preview" type="submit" value="Review this job post" className="review-cta" />
            <span>or</span>
            <input id="submit" type="submit" value="Submit" className="cta main-cta" />
            </div>
    </form>
    )
}
