    ...
    <>
      <section className="banner">
        <div className="wrap">
          ...
          <p>
            We will shortly review it and get it published. Once its live, we
            will let you know per email.
          </p>
        </div>
      </section>
      <section className="plans">
        <div className="wrap">
          <div className="heading">
            ...
            <p>
              Highlighting or featuring your listings will significantly
              increase the number of candidates while at the same time helping
              you to quickly fill your position.
            </p>
          </div>
          <ul>
            <li
              className={
                selectedPlan == 49
                  ? "highlighted-box active"
                  : "highlighted-box"
              }
              onClick={() => {
                handleSelection(49, "USD");
              }}
            >
              ...
              <div className="showcase plan-tier-2">
                ...
                <div className="img-bg">
                  <img
                    src="../../../assets/img/plans/t2.png"
                    alt="Tier 2 - Highlighted"
                  />
                </div>
              </div>
            </li>
          ...
          <div>
            <a
              href="#"
              className="cta free-selection"
              onClick={() => {
                handleSubmit(0);
              }}
            >
              No thanks, I would like to publish for free.
            </a>
            <a
              href="#"
