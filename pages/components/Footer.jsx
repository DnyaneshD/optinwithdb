        ...
        <div className="wrap">
            <div className="content">
                <div>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente magnam suscipit dolorem totam eligendi iusto reprehenderit eos dicta. Culpa expedita ut aspernatur consectetur ex atque, iste nemo et magnam laudantium!</p>
                </div>
                <div>
                    <ul>
                        ...
                        <li><a href="/privary#cookies">Cookies</a></li>
                    </ul>
                    <ul>
                        <li><a href="/about">About</a></li>
                        <li><a href="/new">Post a job</a></li>
