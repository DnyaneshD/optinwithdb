    ...
    <>
        <section className="company-about">
            <div className="wrap back-button-wrap"> 
                {isPreviewMode && <Link className="cta main-cta back-cta" to="/create/preview">Go back</Link>}
            </div>
                ...
                <div className="content">
                    <div className="details">
                        ...
                        <>
                            ...
                            <div className="desc">
                                <p>Status:</p>
                                <p><b>Active, Founder</b></p>
                            </div>
                        </>
                        }

                    </div>
                    <div className="about wysiwyg" dangerouslySetInnerHTML={{__html: company.description}}></div>
                </div>
            </div>
        </section>
        {!isPreviewMode &&
            <Listing showTitle="1" hideFilter="1"  />
        }        
    </>
    )
}
