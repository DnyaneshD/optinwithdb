    ...
    <>
      <section className="full-job-listing">
        <div className="wrap">
          {isPreviewMode && (
            <Link
              className="cta main-cta back-cta"
            ...
            {loading ? (
              ...
              <>
                <div className="heading">
                  <p>
                    <b>{sortDateVisually(jobData.date)}</b>
                  </p>
                  <h1>{jobData.title}</h1>
              ...
              <>
                <div className="highlighted-box">
                  ...
                  <div className="company-logo">
                    <img
                      src={jobData.company && jobData.company.logo}
                      alt="#"
                    />
                  </div>
                  <div className="desc">
                    <p>Headquarters:</p>
                    <p>
                      <b>{jobData.company && jobData.company.location}</b>
                    </p>
                  </div>
                  <div className="desc">
                    <p>About the company</p>
                    {isPreviewMode ? (
                      <Link className="read-more" to="/create/preview/company">
                        Read more...
                      </Link>
                    ) : (
                      <Link className="read-more" to="/companies/hotjar">
                        Read more...
                      </Link>
                    )}
                  </div>
      ...
      <section className="share-panel">
        <div className="wrap">
          <a
            target="_blank"
            href={loading ? "" : jobData.howToApply}
            className="cta main-cta"
          >
            Apply for this job
          </a>
